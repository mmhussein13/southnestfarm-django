"""
Django settings for southnest project.
...
SECRET_KEY = '8f!a=fwmvs07mxm7x0($%q&ln2i)qvogj@^rylo7=3v^r7(eh4'
...
WSGI_APPLICATION = 'southnest.wsgi.application'
